            ...
            <div className="app-layout">
                <div className="ui inverted menu">
                    <div className="ui container">
                        ...
                        <div className="ui simple dropdown item">
                            Events <i className="dropdown icon"></i>
                        </div>

                        <div className="ui simple dropdown item">
                            Auction <i className="dropdown icon"></i>
                        </div>

                        <div className="ui simple dropdown item">
                            Orders <i className="dropdown icon"></i>
                        </div>

                        <div className="ui simple dropdown item">
                            Board <i className="dropdown icon"></i>
                        </div>

                        <div className="ui simple dropdown item">
                            Settings <i className="dropdown icon"></i>
                        </div>
                    </div>
                </div>
                <div className="ui container">
